        ...
        <form>
          <div className="row">
            ...
            <div className="col-sm-3 mb-2">
              <input type="text" value={loginData.email} name="email" onChange={(e) =>inputChange(e)} className="form-control" id="email" placeholder="Email" />
          ...
          <div className="row">
            ...
            <div className="col-sm-3 mb-2">
              <input type="password" value={loginData.password} autoComplete="on" name="password" onChange={(e) => { inputChange(e)} } className="form-control" id="password" placeholder="Password" />
